...
from .serializers import AccountSerializer, ConfirmShipperSerializer, ShipperSerializer, AddressSerializer, UserSerializer, LoginSerializer
...
class ConfirmShipper(APIView):
    ...
    def post(self, request):
        ...
        shipper.url_identification_top = request.data.get(
            'url_identification_top')
        shipper.url_identification_back = request.data.get(
...
class ShipperViewSet(APIView):
    ...
    def get(self, request):
        payload = jwt.decode(jwt=request.headers.get(
